...
-- =============================================================================
-- Keeps ONLY:
--   - Tenants whose `public.tenants.email` is in the keep list below
--   - The platform tenant (tenants.is_platform = true)
--
-- Deletes all other tenant data in FK-safe order.
--
-- Run in Supabase SQL Editor as postgres / service role, or via Supabase CLI.
-- Tip: review first with BEGIN; ... ROLLBACK;
-- =============================================================================
