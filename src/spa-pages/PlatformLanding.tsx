  ...
  return (
    <div className="bg-[#fef9f1] text-[#1d1b17] font-sans selection:bg-[#ffdad6] selection:text-[#410002] overflow-x-hidden min-h-screen">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:scale-110 hover:shadow-[0_6px_20px_rgba(37,211,102,0.6)] transition-all duration-300 flex items-center justify-center animate-bounce-slow"
